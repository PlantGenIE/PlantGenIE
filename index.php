<?php
//if($_SERVER['HTTP_HOST']=="beta.plantgenie.org"){header('Location: https://beta.plantgenie.org/');}
//echo getcwd();
...
$c['themeSelect'] = "blue";
$c['menu'] = "Home<br />\nExample";
$c['title'] = 'Eucalyptus Genome Integrative Explorer';
...
foreach($c as $key => $val){
	...
	switch($key){
		...
		case 'page':
			...
			if($c[$key]=="home"){$c['initialize_tool_plugin']=true;$c['tool_plugin']="home";};
			if(!$c['content']){
